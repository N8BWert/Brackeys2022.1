...
public class DrugChanges : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        this.gameObject.GetComponent<MeshRenderer>().materials[0] = mats[0];
        currentIndex = 0;
    }
    ...
    public void changeState() {
        currentIndex += 1;
        this.gameObject.GetComponent<MeshFilter>().mesh = meshes[currentIndex];
        this.gameObject.GetComponent<MeshRenderer>().materials[0] = mats[currentIndex];
    }
}
